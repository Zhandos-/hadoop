...
public class StockPriceWritable implements WritableComparable<StockPriceWritable>, Cloneable {
  ...
  public StockPriceWritable(String symbol, String date, double open, double high, double low,
  ...
  public static StockPriceWritable fromLine(String line) throws IOException {
    ...
    StockPriceWritable stock = new StockPriceWritable(
        ...
        parts[0], parts[1], Double.valueOf(parts[2]), Double.valueOf(parts[3]),
        Double.valueOf(parts[4]), Double.valueOf(parts[5]), Integer.valueOf(parts[6]),
